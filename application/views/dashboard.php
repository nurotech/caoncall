    ...
    font-size:18px;
            ...
            <nav class="mb-4 navbar navbar-expand-lg navbar-light ">
             ...
             <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link f" href="#">My Account</a>
                        </li>
                          <li class="nav-item">
                  ...
                  <ul class="navbar-nav mr-auto">
                       <li class="nav-item">
                <a class="nav-link btn btn-sm btn-primary" href="<?php echo site_url('profile')?>">Profile</a>
                                 </li>
          <li class="nav-item">
            ...
            <div class="container">
              <h2 class="text-align:center" style="color:#1a73e8">Welcome to User Panel</h2>
