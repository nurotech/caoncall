		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-content collapse show">
					...
					if(!empty($expert_details)){
					    $action_url=site_url("expert/profile?expert_id=".$expert_details['id']);
					}else{
					    $action_url=site_url("expert/profile");
					}
          ...
          $expert_info=$this->session->userdata('expert');
					?>
			                 ...
			                 <input type="hidden" name="form_edit_id" value="<?php echo $expert_info['id']?>">
                        <div class="form-body">
                              ...
                              <div class="form-group col-md-6 mb-2">
                               ...
                               <div class="form-group col-md-6 mb-2">
                                <label for="userinput2">Password</label>
                                  ...
                                  <small><b>Note</b>If, you don't want to chnage password then leave blank or enter password .</small>
                              </div>
                            </div>
