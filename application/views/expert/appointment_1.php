    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" id="basic-layout-form-center">Expert Appointment Details</h4>
        ...
        <div class="card-content collapse show">
          ...
          //if(!empty($appt_list)){
              //$action_url=site_url("expert/appointment?app_id=".$appt_list['app_id']);
          //}else{
              $action_url=site_url("expert/appointment");
          //}         
          ?>
        <form class="form" method="post" action="<?php echo $action_url ?>">

        	<input type="hidden" name="form_expert_id" value="<?php echo $apnt_edit['expert_id']?>">
        	<input type="hidden" name="form_apnt_date" value="<?php echo $apnt_edit['date']?>">
                ...
                <div class="col-md-6">
                   ...
                   <div class="form-body">
                    <div class="form-group">
                      ...
                      <input autocomplete="off" type="text" id="expert_id" name="name" class="form-control" placeholder="expert name">
                    </div>
                  </div>
                  </div>
