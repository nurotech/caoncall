      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Sub Category Management</h3>
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Sub Category</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">View Sub Category</a>
                  </li>                 
                </ol>
              </div>
            </div>
        ...
        <?php
          $cate_info=get_category_info($this->uri->segment(4));
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" id="basic-layout-form-center">Sub Category Details - <span class="text-primary"><?php 
            echo $cate_info['cat_name'];
          ?></span></h4>
        ...
        <div class="card-body card-dashboard">
                        ...
                        <thead>
                            ...
                            <?php              
                              ...
                              if(!empty($sub_cats)){
                                  $sr_no=1;
                        foreach($sub_cats as $mk=>$mv){
                          ?>
                          <tr>
                          <td><?php echo $sr_no;?></td>
                          <td>
                         <?php echo $mv['cat_name']; ?>
                            </td>                 
                            <td>
                            <?php 
                            if($mv['status']=="1"){
                            $link=site_url('admin/category/update_status/'.$mv['cat_id'].'/0/'.$this->uri->segment(4));
                            echo '<a title="Inactive" class="text-danger" data-toggle="tooltip"  href="'.$link.'"><i class="fa fa-ban"></i></a>'; 
                            }else{
                           $link=site_url('admin/category/update_status/'.$mv['cat_id'].'/1/'.$this->uri->segment(4));
                          ...
                          <a class='text-danger' href="<?php echo site_url('admin/category/sub_delete?cat_id='.$mv['cat_id']); ?>"><i class="fa fa-close"></i></a>          
                          </td>
                           </tr> 
                          <?php                         
                          $sr_no++;
