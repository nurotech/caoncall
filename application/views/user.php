...
<head>
  ...
  <!--favicon-->
  <link rel="icon" href="<?= base_url('ca_assets/admin/assets/images/favicon.ico')?>" type="image/x-icon">
  <!-- simplebar CSS-->
  <link href="<?= base_url('ca_assets/admin/assets/plugins/simplebar/css/simplebar.css')?>" rel="stylesheet"/>
  <!-- Bootstrap core CSS-->
  <link href="<?= base_url('ca_assets/admin/assets/css/bootstrap.min.css')?>" rel="stylesheet"/>
  <!-- animate CSS-->
  <link href="<?= base_url('ca_assets/admin/assets/css/animate.css')?>" rel="stylesheet" type="text/css"/>
  <!-- Icons CSS-->
  <link href="<?= base_url('ca_assets/admin/assets/css/icons.css')?>" rel="stylesheet" type="text/css"/>
  <!-- Sidebar CSS-->
  <link href="<?= base_url('ca_assets/admin/assets/css/sidebar-menu.css')?>" rel="stylesheet"/>
  <!-- Custom Style-->
  <link href="<?= base_url('ca_assets/admin/assets/css/app-style.css')?>" rel="stylesheet"/>
 ...
 <!--Start sidebar-wrapper-->
   <div id="sidebar-wrapper" class="bg-theme bg-theme2" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="index.html">
       <img src="<?= base_url('ca_assets/admin/assets/images/logo-icon.png') ?>" class="logo-icon" alt="logo icon">
       <h5 class="logo-text">Dashboard</h5>
     </a>
   </div>
   <div class="user-details">
	  <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
	    <div class="avatar"><img class="mr-3 side-user-img" src="<?= base_url('ca_assets/admin/assets/images/avatars/avatar-13.png')?>" alt="user avatar"></div>
	   ...
	   <div id="user-dropdown" class="collapse">
		  <ul class="user-setting-menu">
			...
			<li><a href="<?php echo base_url('logout/checkLogout') ?> "><i class="icon-power"></i>Logout</a></li>
		  </ul>
	   </div>
      </div>
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
		...
		<ul class="sidebar-submenu">
		  <li><a href="<?php echo base_url('user/adduser')?>"><i class="zmdi zmdi-long-arrow-right"></i> Add User</a></li>
          <li><a href="<?php echo base_url('user')?>"><i class="zmdi zmdi-long-arrow-right"></i> User List </a></li>
		</ul>
      </li>
      <!-- 
      <li>
  ...
  <ul class="navbar-nav align-items-center right-nav-link">
        ...
        <ul class="list-group list-group-flush">
         <li class="list-group-item d-flex justify-content-between align-items-center">
          ...
          <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="<?= base_url('ca_assets/admin/assets/images/avatars/avatar-5.png')?>" alt="user avatar"></div>
            <div class="media-body">
          ...
          <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="<?= base_url('ca_assets/admin/assets/images/avatars/avatar-6.png')?>" alt="user avatar"></div>
            <div class="media-body">
          ...
          <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="<?= base_url('ca_assets/admin/assets/images/avatars/avatar-7.png')?>" alt="user avatar"></div>
            <div class="media-body">
          ...
          <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="<?= base_url('ca_assets/admin/assets/images/avatars/avatar-8.png')?>" alt="user avatar"></div>
            <div class="media-body">
    ...
    <li class="nav-item">
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="pages-blank-page.html#">
        <span class="user-profile"><img src="<?= base_url('ca_assets/admin/assets/images/avatars/avatar-13.png')?>" class="img-circle" alt="user avatar"></span>
      </a>
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="<?= base_url('ca_assets/admin/assets/images/avatars/avatar-13.png')?>" alt="user avatar"></div>
            <div class="media-body">
            <h6 class="mt-2 user-title">yogya</h6>
            <p class="user-subtitle">info@yogya.com</p>
            </div>
           </div>
          </a>
        </li>
        ...
        <li class="dropdown-divider"></li>
        <li class="dropdown-item"><a href="<?php echo base_url('logout/checkLogout') ?>"<i class="icon-power mr-2"></i> Logout</a></li>
      </ul>
    </li>
  </ul>
</nav>
...
<div class="clearfix"></div>
  <div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form action="<?php echo base_url('user/adduser') ?>" method="post" id="personal-info">
                ...
                <div class="form-group row">
                  <label for="input-2" class="col-sm-2 col-form-label">Mobile</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-2" name="mobile" required>
                        <span id="mobile-availability" style="font-size:12px;"></span>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-2" class="col-sm-2 col-form-label">Email</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-2" name="email" required>
                  </div>
                </div>
  ...
  <script src="<?= base_url('ca_assets/admin/assets/js/jquery.min.js')?>"></script>
  <script src="<?= base_url('ca_assets/admin/assets/js/popper.min.js')?>"></script>
  <script src="<?= base_url('ca_assets/admin/assets/js/bootstrap.min.js')?>"></script>
	
  <!-- simplebar js -->
  <script src="<?= base_url('ca_assets/admin/assets/plugins/simplebar/js/simplebar.js')?>"></script>
  <!-- sidebar-menu js -->
  <script src="<?= base_url('ca_assets/admin/assets/js/sidebar-menu.js')?>"></script>
  
  <!-- Custom scripts -->
  <script src="<?= base_url('ca_assets/admin/assets/js/app-script.js')?>"></script>
